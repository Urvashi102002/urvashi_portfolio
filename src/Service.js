...
import "./Service.css";
import service1 from './img/download (2).jpg';
import service2 from './img/download (1).jpg';
import service3 from './img/download.png';
        ...
        <div className="row">
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">HTML / CSS / JAVASCRIPT</h1>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">REACT / NODE JS. / EXPRESS JS. / MONGODB</h1>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">UI/UX / FIGMA / ADOBE </h1>
...
export default Service;
          {/* <div className="col__3">
            <div className="service__box pointer">
              ...
              {/* </div>
              <div className="service__meta"> */}
                {/* <h1 className="service__text">JAVA / C</h1> */}
                {/* <p className="p service__text p__color">
                  I throw myself down among the
                </p>
                <p className="p service__text p__color">
